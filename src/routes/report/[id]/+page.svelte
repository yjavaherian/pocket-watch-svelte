...
<main>
    <header class="flex flex-col bg-blue-50 p-4">
    ...
    <table class="border-y">
        <thead class="text-left bg-amber-50">
            <tr>
                <th class="w-32 border-stone-300 px-1 py-1 border">Date</th>
                <th class="w-32 border-stone-300 px-1 py-1 border"
                    >Start Time</th
                >
                <th class="w-32 border-stone-300 px-1 py-1 border">End Time</th>
                <th class="w-32 border-stone-300 px-1 py-1 border">Duration</th>
                <th class="w-96 border-stone-300 px-1 py-1 border">Desc</th>
            </tr>
        </thead>
        <tbody>
    ...
    <section class="flex flex-row gap-20 text-lg">
